...
<form:form modelAttribute="pdto" action="mPwChange" >
		...
		<div class="form-row">
			...
			<div class="col-md-6 mb-3 d-flex justify-content-center">
				<input type="button" class="btn btn-outline-secondary col-5 mx-auto" id="mPwChangeBtn" value="수정">
				<input type="button" class="btn btn-outline-secondary col-5 mx-auto" id="cancleBtn" value="취소">
			</div>
		</div>
</form:form>
</section>
