...
<div class="form replyFormAndList">
	<div class="row justify-content-end">
		<textarea class="form-control col-sm-11" id="rcontent" name="rcontent"
			rows="3" placeholder="[댓글작성 100자 이하]"></textarea>
	</div>
	<div class="row justify-content-end my-1">
		<div class="col-sm-3 col-lg-2 px-2 m-1">
			<button class="btn btn-outline-secondary btn-block"
				id="replyCancleBtn">취소</button>
		</div>
		<div class="col-sm-3 col-lg-2 px-2 m-1">
	...
	<!-- 페이징 -->
	<div id="paging" class="row justify-content-center my-3"></div>
</div>